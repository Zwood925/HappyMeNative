...
const styles = StyleSheet.create({ center: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 28 }, icon: { width: 72, height: 72, borderRadius: 25, alignItems: "center", justifyContent: "center", marginBottom: 18 }, eyebrow: { fontSize: 13, lineHeight: 20, letterSpacing: 1.4, fontWeight: "900", marginBottom: 7 }, title: { fontSize: 30, lineHeight: 37, fontWeight: "900", letterSpacing: -0.6, textAlign: "center" }, body: { fontSize: 15, lineHeight: 22, textAlign: "center", maxWidth: 330, marginTop: 8 }, code: { width: "100%", minHeight: 76, paddingVertical: 14, borderRadius: 20, alignItems: "center", justifyContent: "center", marginTop: 22 }, codeLabel: { fontSize: 13, lineHeight: 18, letterSpacing: 1.1, fontWeight: "800" }, codeValue: { fontSize: 20, lineHeight: 26, letterSpacing: 3, fontWeight: "900", marginTop: 2 }, primary: { width: "100%", minHeight: 56, paddingVertical: 12, borderRadius: 27, marginTop: 18, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, primaryText: { fontSize: 15, lineHeight: 20, fontWeight: "900" }, error: { fontSize: 15, lineHeight: 21, textAlign: "center", marginTop: 12, fontWeight: "700" }, footnote: { fontSize: 15, lineHeight: 21, textAlign: "center", maxWidth: 330, marginTop: 13 } });
