...
const styles = StyleSheet.create({ flex: { flex: 1 }, scroll: { flexGrow: 1, justifyContent: "center", paddingHorizontal: 22, paddingVertical: 34, gap: 22 }, center: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 30 }, brand: { alignItems: "center" }, heroIcon: { width: 68, height: 68, borderRadius: 24, alignItems: "center", justifyContent: "center", marginBottom: 17 }, eyebrow: { fontSize: 10, lineHeight: 14, letterSpacing: 1.4, fontWeight: "900", marginBottom: 7 }, title: { fontSize: 32, lineHeight: 39, fontWeight: "900", letterSpacing: -0.7, textAlign: "center" }, subtitle: { fontSize: 15, lineHeight: 22, textAlign: "center", maxWidth: 340, marginTop: 8 }, card: { borderRadius: 28, borderWidth: 1, padding: 16, gap: 12 }, modeRow: { flexDirection: "row", borderRadius: 18, padding: 4, marginBottom: 2 }, mode: { flex: 1, minHeight: 42, borderRadius: 14, alignItems: "center", justifyContent: "center" }, modeText: { fontSize: 13, lineHeight: 18, fontWeight: "900" }, input: { minHeight: 53, borderRadius: 17, borderWidth: 1, paddingHorizontal: 15, fontSize: 15, lineHeight: 21 }, helper: { fontSize: 11, lineHeight: 16, marginHorizontal: 4 }, error: { fontSize: 12, lineHeight: 17, fontWeight: "700", marginHorizontal: 4 }, notice: { fontSize: 12, lineHeight: 17, fontWeight: "800", marginHorizontal: 4 }, forgot: { alignSelf: "flex-end", minHeight: 34, justifyContent: "center", paddingHorizontal: 3 }, forgotText: { fontSize: 12, lineHeight: 17, fontWeight: "900" }, primaryButton: { minHeight: 54, borderRadius: 27, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 3 }, primaryText: { fontSize: 15, lineHeight: 20, fontWeight: "900" }, secondaryButton: { minHeight: 50, borderWidth: 1, borderRadius: 25, alignItems: "center", justifyContent: "center", alignSelf: "stretch", marginTop: 24 }, secondaryText: { fontSize: 14, lineHeight: 19, fontWeight: "900" }, promise: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingHorizontal: 18 }, promiseText: { fontSize: 11, lineHeight: 16, flexShrink: 1 } });
