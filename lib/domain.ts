...
export interface Pod { id: string; name: string; description: string; color: string; memberIds: string[]; inviteCode: string; inviteToken?: string; ownerId?: string; createdAt: string }
...
export interface HappyState extends HappySnapshot { hydrated: boolean; syncing: boolean; syncError?: string }
